...
public class CartController {
    ...
    public ResponseEntity<?> addItemToCart(@RequestBody CartDTO cartRequest) {
        ...
        System.out.println("This is the user Cart: " + userCart.getUser().getId());
    ...
    public ResponseEntity<List<CartItem>> returnItemInCart(@RequestParam Long cartId,@PathVariable Long itemId,@RequestParam int quantity){
